...
//   const [percent, setPercent] = useState(0.5); // default 0.5%, dynamic for USDT only
//   const [whereAmountGo, setWhereAmountGo] = useState(""); // default 0.5%, dynamic for USDT only
//   const [fromWhereLeft, setFromWhereLeft] = useState(""); // default 0.5%, dynamic for USDT only
...
//       try {
//         const [clientsRes, coursesRes, transactionsRes, balancesRes] =
//           await Promise.all([
//             fetch("/api/clients"),
//             fetch("/api/courses"),
...
//           );
//         } else {
//           // fallback to AMD and USDT if no courses loaded
//           setGiveCurrency("AMD");
...
//   // Calculate receive amount whenever giveAmount, giveCurrency, receiveCurrency, or percent changes
//   useEffect(() => {
//     if (
//       !giveAmount ||
//       isNaN(giveAmount) ||
...
//       giveRate = RATES["USD"].buy * (1 - percent / 100); // -percent% от USD
//     }

//     // Курс receiveCurrency
//     let receiveRate = RATES[receiveCurrency].sell;
//     if (receiveCurrency === "USDT") {
//       receiveRate = RATES["USD"].buy * (1 - percent / 100); // -0.5% от USD
//     }

//     const rate = giveRate / receiveRate;

//     const finalAmount = parseFloat(giveAmount) * rate;

//     setReceiveAmount(finalAmount.toFixed(2));
//   }, [giveAmount, giveCurrency, receiveCurrency, RATES, percent]);
...
//       exchangeRate: parseFloat(receiveAmount) / parseFloat(giveAmount),
//       method: "cash",
...
//       // Add a window event listener to trigger refetch for balances
...
//   // Build unique currency list including AMD and USDT
