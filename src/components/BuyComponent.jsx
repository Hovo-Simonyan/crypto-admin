...
//   // Prepare rates lookup WITHOUT static percentage on USDT
//   const RATES = useMemo(() => {
//     const result = {};
...
//   // Always set receiveCurrency based on giveCurrency
//   useEffect(() => {
...
//   useEffect(() => {
//     if (!RATES[giveCurrency] || !giveAmount) {
//       setReceiveAmount("");
//       setExchangeRate(0);
//       return;
//     }
...
//     let actualRate; // сюда сохраним курс для state

//     if (giveCurrency === "USD") {
//       amountConvertedToUsdt = amountNum * (1 - parseFloat(percent) / 100);
//       actualRate = amountConvertedToUsdt / amountNum; // фактический обменный курс
//     } else {
//       let adjustedRate;
...
//   }, [giveAmount, giveCurrency, RATES, percent, receiveCurrency]);
